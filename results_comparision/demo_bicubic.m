...
aver_UIQI = 0;
aver_ERGAS = 0;
outpath = ['bicubic_results/',datasetname,'/',num2str(upscale),'/'];
mkdir(outpath);
for i = 1:length(files)
    ...
    upsample_t = imresize(upsample_t, upscale, 'bicubic');
